...
export default function DevMode({
  ...
  useEffect(() => {
    const steps: Omit<BootLine, 'ok'>[] = [
      { t: 0, text: 'booting viperxu-shell v0.1 ...' },
      { t: 180, text: 'loading /etc/personality.conf' },
      { t: 420, text: `mounting /blog (${blogCount} entries)` },
      { t: 710, text: 'spinning up local agent mock' },
      { t: 1020, text: 'resolving @mascot/cat -> ok' },
      { t: 1260, text: 'ready.' }
    ]
        ...
        {bootDone && (
          <div className='dev-neofetch'>
            <div className='dev-neo-mascot'>
              ...
              <span className='dev-neo-mascot-caption'>cat avatar v0.1 · learning</span>
            </div>
